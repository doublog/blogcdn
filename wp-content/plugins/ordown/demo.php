...
<div id="previewbar">
<div id="previewlogo" style="background: url(<?php echo get_option('ordown_ad6');?>) no-repeat 20px 50%;"><?php echo $title;?>官方演示</div>
...
<?php if($ordown_downurl3){ ?>
<div id="previewframe">
	<iframe src="<?php echo $ordown_downurl3;?>" frameborder="0"></iframe>
</div>
<?php }
?>
