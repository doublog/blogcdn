...
class git_social extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        if (git_get_option('git_weibo')) echo '<a href="' . git_get_option('git_weibo') . '" rel="external nofollow" title="Facebook" target="_blank"><i class="sinaweibo fa fa-facebook"></i></a>';
