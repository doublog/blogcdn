...
function add_checkbox() {   
   if (!is_user_logged_in()) {
      ...
      $content.= '<span style="font-weight:bold;text-shadow:0 1px 0 #ddd;">  声明:</span> 本博采用 <a rel="nofollow" href="http://creativecommons.org/licenses/by-nc-sa/4.0/" title="署名-非商业性使用-相同方式共享">BY-NC-SA</a> 协议进行授权';
      echo $content;
   } 
}   
